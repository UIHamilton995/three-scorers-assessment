...
import log from "./User.module.css";
    ...
    <div className={log.users}>
      <div className={log.div}>
          ...
          <div className={log.overlap_group}>
            ...
            <div className={log.frame}>
              ...
              <div className={log.group2}>
                ...
                <Outline className={log.icon_instance_node} color="#303030" />
              </div>
              <div className={log.group3}>
                <div className={log.text_wrapper3}>Admins</div>
        ...
        <div className={log.overlap2}>
          <div className={log.text_wrapper4}>Users</div>
              ...
              <div className={log.employer_s_list}>
                <div className={log.overlap_group2}>
                  <div className={log.overlap4}>
                    ...
                    <div className={log.text_wrapper7}>Search for User</div>
                    <img className={log.img} alt="Vector" src="vector.svg" />
                  </div>
                  <div className={log.text_wrapper8}>User’s Name</div>
